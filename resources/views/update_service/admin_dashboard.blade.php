...
<head>
    ...
    <style>
        * {
        ...
        .contract-row {
            grid-template-columns: 110px 1fr 1fr 1fr 130px 115px 115px 96px 130px;
        }
...
<body class="ar">
    <div class="layout">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="tb-right">
                    <div class="tb-srch"><i class="ti ti-search tb-srch-ico"></i><input type="text"
                            id="srch-inp" placeholder="بحث في الطلبات..." /></div>
                    ...
                    <form id="nb-logout-form" method="POST" action="{{ route('amrtm.logout') }}"
                        style="display:none;">
                        @csrf
                    </form>
            ...
            <div class="content">
                ...
                @if (auth('business')->user()->role === 'supervisor')
                    ...
                    <div class="page on" id="page-overview">
                        <div class="pg-hd">
                            ...
                            <button class="btn-pri" onclick="showPage('requests')"><i
                                    class="ti ti-file-text"></i><span id="ov-view-req">عرض الطلبات</span></button>
                        </div>
                        <div class="stat-grid">
                            <div class="sc">
                            ...
                            <div class="sc">
                                <div class="sc-ico" style="background:rgba(27,94,32,.1)"><i
                            ...
                            <div class="sc">
                                <div class="sc-ico" style="background:rgba(198,40,40,.1)"><i class="ti ti-x"
                            ...
                            <div class="chart-card">
                                ...
                                <div class="donut-wrap">
                                    ...
                                    <div class="donut-legend">
                                        <div class="dl-item">
                                            <div class="dl-dot" style="background:var(--blue)"></div><span
                                                id="dl1">جاري (0)</span>
                                        </div>
                                        <div class="dl-item">
                                            <div class="dl-dot" style="background:var(--orange)"></div><span
                                                id="dl2">انتظار (0)</span>
                                        </div>
                                        <div class="dl-item">
                                            <div class="dl-dot" style="background:var(--green)"></div><span
                                                id="dl3">مكتملة (0)</span>
                                        </div>
                                        <div class="dl-item">
                                            <div class="dl-dot" style="background:var(--red)"></div><span
                                                id="dl4">مرفوضة (0)</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="page" id="page-requests">
                    ...
                    <div class="req-filters">
                        ...
                        <button class="rf-btn" onclick="filterReqs('pending',this)" id="rf-pend">قيد
                            الانتظار</button>
                        <button class="rf-btn" onclick="filterReqs('processing',this)" id="rf-proc">جاري
                            المعالجة</button>
                ...
                <div class="page" id="page-contracts">
                    <div class="pg-hd">
                        ...
                        <button class="btn-pri" onclick="addContract()"><i class="ti ti-plus"></i> إضافة عقد جديد</button>
                    </div>
                    ...
                    <div class="contract-tools">
                        ...
                        <form class="contract-search" onsubmit="return false;">
                            ...
                            <input type="text" id="contract-search" placeholder="ابحث برقم العقد أو الجوال أو الإيميل أو اسم الشركة..."
                                oninput="renderContractsList()" />
                            <button type="button" class="contract-search-clear" onclick="clearContractSearch()"
                                title="مسح"><i class="ti ti-x"></i></button>
                        </form>
                    </div>
                    ...
                    <div class="cat-tab-panel" id="contract-panel-clauses">
                        ...
                        <div class="cat-add-form" id="contract-type-form" style="display:none;margin-bottom:1.2rem;">
                            ...
                            <div class="cat-form-grid" style="grid-template-columns:1.6fr 1fr;align-items:start;"
                                ...
                                <div>
                                    <label>اسم نوع العقد *</label>
                                    <input type="text" id="ct-name" placeholder="مثال: عقد تسويق إلكتروني" />
                                </div>
                                <div>
                                    <label>سعر الخدمة (ر.س)</label>
                                    <input type="number" id="ct-price" min="0" step="0.01" placeholder="5000" />
                                </div>
                            </div>

                            <div style="display:flex;gap:.6rem;align-items:center;">
                                <button type="button" class="btn-pri" onclick="saveContractType()">
                                    <i class="ti ti-check"></i> حفظ النوع
                                </button>
                                <button type="button" class="btn-sec" id="contract-type-form-cancel"
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;gap:.8rem;margin-bottom:.9rem;">
                            ...
                            <button type="button" class="btn-pri" onclick="toggleContractTypeForm()"
                        ...
                        <div id="contract-clauses-detail" style="display:none;">
                            ...
                            <div class="cat-add-form" id="clause-form">
                                ...
                                <div class="cat-form-grid" style="grid-template-columns:1fr 1.6fr;align-items:start;">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="cl-desc" rows="6" style="min-height:150px;" placeholder="وصف تفصيلي للبند..."></textarea>
                                    </div>
                                </div>
                                ...
                                <div style="display:flex;gap:.6rem;align-items:center;">
                                    ...
                                    <button type="button" class="btn-sec" id="clause-form-cancel"
                            ...
                            <div class="contract-clauses-toolbar">
                                ...
                                <button class="cat-act-btn del" id="clause-bulk-del"
                ...
                <div class="page" id="page-finance">
                    <div class="pg-hd">
                        ...
                        <button class="btn-pri"><i class="ti ti-download"></i><span
                                id="fin-exp">تصدير</span></button>
                    </div>
                ...
                <div class="page" id="page-off-finance">
                    <div class="pg-hd">
                        ...
                        <div style="display:flex;gap:8px;align-items:center">
                            ...
                            <input type="date" id="ofl-to"
                                style="padding:7px 10px;border:1.5px solid #E0E0E0;border-radius:8px;font-size:12px;font-family:inherit">
                            <button class="btn-pri" onclick="loadOfficeFinancial()"><i
                                    class="ti ti-refresh"></i></button>
                            <button class="btn-pri" style="background:#1B5E20"
                                onclick="exportOfficeFinancialCSV()"><i class="ti ti-download"></i> تصدير</button>
                        </div>
                    </div>
                    <div class="stat-grid" style="margin-bottom:1.3rem">
                        ...
                        <div class="sc">
                            <div class="sc-ico" style="background:rgba(230,81,0,.1)"><i
                                    class="ti ti-building-community" style="color:var(--orange)"></i></div>
                            <div>
                    ...
                    <div
                        ...
                        <div
                            style="padding:1rem 1.2rem;font-weight:800;font-size:14px;border-bottom:1px solid var(--b1)">
                            أداء كل مكتب</div>
                        <div style="overflow-x:auto">
                            <table>
                                ...
                                <tbody id="ofl-by-office">
                                    <tr>
                                        <td colspan="7" style="text-align:center;padding:2rem;color:var(--t3)">جارٍ
                                            التحميل...</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div style="overflow-x:auto">
                            <table>
                                ...
                                <tbody id="ofl-monthly">
                                    <tr>
                                        <td colspan="4" style="text-align:center;padding:2rem;color:var(--t3)">جارٍ
                                            التحميل...</td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="page" id="page-catalog">
                    ...
                    <div class="cat-tab-panel on" id="cat-panel-categories">
                        <div class="cat-add-form">
                            <div class="cat-form-ttl"><i class="ti ti-plus" style="color:var(--pri)"></i> إضافة تصنيف
                                جديد</div>
                            <div class="cat-form-grid">
                                <div><label>الاسم (عربي) *</label><input type="text" id="cat-name-ar"
                                        placeholder="مثال: الوزارات" /></div>
                                <div><label>الاسم (إنجليزي) *</label><input type="text" id="cat-name-en"
                                        placeholder="e.g. Ministries" /></div>
                                <div><label>المفتاح (key) *</label><input type="text" id="cat-key"
                                        placeholder="ministries" /></div>
                                <div><label>الأيقونة *</label>
                                    <div style="display:flex;gap:5px;"><input type="text" id="cat-icon"
                                            placeholder="ti-building-bank" style="flex:1;min-width:0;" /><button
                                            type="button"
                                            onclick="openIconPicker(document.getElementById('cat-icon'))"
                                ...
                                <div><label>الترتيب</label><input type="number" id="cat-sort" placeholder="1"
                                        min="0" /></div>
                            </div>
                            <button class="btn-pri" onclick="doCreateCategory()"><i class="ti ti-plus"></i> حفظ
                                التصنيف</button>
                        </div>
                        <div class="cat-list">
                    ...
                    <div class="cat-tab-panel" id="cat-panel-entities">
                        <div class="cat-add-form">
                            <div class="cat-form-ttl"><i class="ti ti-plus" style="color:var(--pri)"></i> إضافة جهة
                                جديدة</div>
                            <div class="cat-form-grid">
                                ...
                                <div><label>الأيقونة *</label>
                                    <div style="display:flex;gap:5px;"><input type="text" id="ent-icon"
                                            placeholder="ti-shield" style="flex:1;min-width:0;" /><button
                                            type="button"
                                            onclick="openIconPicker(document.getElementById('ent-icon'))"
                                            title="اختر من المكتبة"
                                            style="height:42px;padding:0 11px;border-radius:9px;border:1.5px solid rgba(26,35,126,.2);background:rgba(26,35,126,.06);color:#1A237E;cursor:pointer;flex-shrink:0;font-size:15px;line-height:1;"><i
                                                class="ti ti-photo"></i></button></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="ent-image" accept="image/*"
        ...
        ">
                                ...
                                <div><label>التاق (عربي)</label><input type="text" id="ent-tag-ar"
                                        placeholder="الأمن والمواطنة" /></div>
                                <div><label>التاق (إنجليزي)</label><input type="text" id="ent-tag-en"
                                        placeholder="Security &amp; Citizenship" /></div>
                                <div><label>الترتيب</label><input type="number" id="ent-sort" placeholder="1"
                                        min="0" /></div>
                            </div>
                            <div style="display:flex;gap:.8rem;flex-wrap:wrap;align-items:center;margin-bottom:.8rem;">
                                <label style="font-size:12.5px;font-weight:700;color:var(--t2);">فلترة القائمة حسب
                                    التصنيف:</label>
                            ...
                            <button class="btn-pri" onclick="doCreateEntity()"><i class="ti ti-plus"></i> حفظ
                                الجهة</button>
                        </div>
                        <div class="cat-list">
                            <div class="cat-list-hd" style="grid-template-columns:36px 1fr 1fr 80px 60px 120px;">
                    ...
                    <div class="cat-tab-panel" id="cat-panel-services">
                        <div class="cat-add-form">
                            <div class="cat-form-ttl"><i class="ti ti-plus" style="color:var(--pri)"></i> إضافة خدمة
                                جديدة</div>
                            <div class="cat-form-grid">
                                ...
                                <div><label>الأيقونة *</label>
                                    <div style="display:flex;gap:5px;"><input type="text" id="svc-icon"
                                            placeholder="ti-id" style="flex:1;min-width:0;" /><button type="button"
                                            onclick="openIconPicker(document.getElementById('svc-icon'))"
                                            title="اختر من المكتبة"
                                            style="height:42px;padding:0 11px;border-radius:9px;border:1.5px solid rgba(26,35,126,.2);background:rgba(26,35,126,.06);color:#1A237E;cursor:pointer;flex-shrink:0;font-size:15px;line-height:1;"><i
                                                class="ti ti-photo"></i></button></div>
                                </div>
                                <div><label>السعر (ر.س) *</label><input type="number" id="svc-price"
                                        placeholder="300" min="0" step="0.01" /></div>
                                <div><label>أيام الإنجاز المتوقعة *</label><input type="number" id="svc-days"
                                        placeholder="5" min="1" /></div>
                                <div><label>وصف (عربي)</label><input type="text" id="svc-desc-ar"
                                        placeholder="وصف الخدمة..." /></div>
                                <div><label>وصف (إنجليزي)</label><input type="text" id="svc-desc-en"
                                        placeholder="Service description..." /></div>
                                <div><label>الترتيب</label><input type="number" id="svc-sort" placeholder="1"
                                        min="0" /></div>
                            </div>
                            <div style="display:flex;gap:.8rem;flex-wrap:wrap;align-items:center;margin-bottom:.8rem;">
                                <label style="font-size:12.5px;font-weight:700;color:var(--t2);">فلترة القائمة حسب
                            ...
                            <button class="btn-pri" onclick="doCreateService()"><i class="ti ti-plus"></i> حفظ
                                الخدمة</button>
                        </div>
                        <div class="cat-list">
                ...
                <div class="page" id="page-users">
                    ...
                    <div style="display:flex;gap:.7rem;margin-bottom:1rem;">
                        <div class="tb-srch" style="flex:1;max-width:340px;"><i
                                class="ti ti-search tb-srch-ico"></i><input type="text" id="usr-srch"
                ...
                <div class="page" id="page-logs">
                    ...
                    <div style="display:flex;gap:.7rem;margin-bottom:1rem;">
                        <div class="tb-srch" style="flex:1;max-width:340px;"><i
                                class="ti ti-search tb-srch-ico"></i><input type="text" id="log-srch"
                ...
                <div class="page" id="page-offices">
                    ...
                    <div class="off-type-tabs" style="display:flex;gap:.5rem;flex-wrap:wrap;margin-bottom:1rem;">
                        ...
                        <button class="rf-btn" style="font-size:11px;"
                            onclick="filterOfficeType('law',this)">محاماة</button>
                        <button class="rf-btn" style="font-size:11px;"
                            onclick="filterOfficeType('services',this)">تعقيب وخدمات</button>
                        <button class="rf-btn" style="font-size:11px;"
                            onclick="filterOfficeType('customs',this)">جمارك</button>
                        <button class="rf-btn" style="font-size:11px;"
                            onclick="filterOfficeType('accounting',this)">محاسبين</button>
                        <button class="rf-btn" style="font-size:11px;"
                            onclick="filterOfficeType('engineering',this)">هندسة</button>
                        <button class="rf-btn" style="font-size:11px;"
                            onclick="filterOfficeType('freelance',this)">اصحاب مهن</button>
                    </div>
                    <div id="off-list">
                        <div style="text-align:center;padding:3rem;color:var(--t3);">جارٍ التحميل...</div>
                    </div>
    ...
    ">
        ...
        ">
                        ...
                        <select id="specialty-filter-type" onchange="loadOfficeSpecialties(this.value)"
                            style="
                height:38px;
                padding:0 12px;
                border-radius:9px;
            ...
            ">
                ...
                <div class="page" id="page-permissions">
                    <div class="pg-hd">
                        ...
                        <button class="btn-pri" onclick="showCreateAdminModal()"><i
                                class="ti ti-user-plus"></i><span>إضافة مدير</span></button>
                    </div>
                    <div id="admins-list">
                        <div style="text-align:center;padding:3rem;color:var(--t3);">جارٍ التحميل...</div>
                    </div>
                ...
                <div class="page" id="page-settings">
                    ...
                    <div class="chart-card" style="max-width:520px;">
                        ...
                        <div style="display:flex;flex-direction:column;gap:1rem;">
                            <div><label
                                    style="font-size:12.5px;font-weight:700;color:var(--t1);display:block;margin-bottom:5px;"
                            ...
                            <div><label
                                    style="font-size:12.5px;font-weight:700;color:var(--t1);display:block;margin-bottom:5px;"
                                    id="set-lbl-em">البريد الإلكتروني</label><input type="email"
                                    value="admin@amrtm.com.sa"
                                    style="width:100%;height:44px;padding:0 13px;border-radius:10px;border:1.5px solid var(--b1);background:var(--sur2);color:var(--t1);font-family:inherit;font-size:13.5px;outline:none;" />
                            </div>
                            <button class="btn-pri" style="align-self:flex-start;" id="set-save"><i
                                    class="ti ti-check"></i><span id="set-save-l">حفظ التغييرات</span></button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-ov" id="balance-modal">
        <div class="modal-box">
            <div class="modal-ttl"><i class="ti ti-wallet" style="color:var(--pri)"></i><span
                    id="bal-modal-ttl">تعديل الرصيد</span></div>
            <div
                ...
                <span style="font-size:13px;color:var(--t3);">الرصيد الحالي: <strong id="bal-current"
                        style="color:var(--pri)">0 ر.س</strong></span>
            </div>
            <div class="modal-fld">
                ...
                <div style="display:flex;gap:.5rem;">
                    <label
                        ...
                        id="bal-charge-lbl">
                        <input type="radio" name="bal-type" value="charge" checked
                            onchange="updateBalTypeUI()" />
                        <span style="font-size:13px;font-weight:700;color:var(--green);">شحن رصيد</span>
                    </label>
                    <label
                        style="flex:1;display:flex;align-items:center;gap:.5rem;padding:.7rem;border-radius:9px;border:1.5px solid var(--b1);cursor:pointer;"
                        id="bal-deduct-lbl">
                        <input type="radio" name="bal-type" value="payment" onchange="updateBalTypeUI()" />
                        <span style="font-size:13px;font-weight:700;color:var(--red);">خصم رصيد</span>
                    </label>
                </div>
            </div>
            <div class="modal-fld"><label>المبلغ (ر.س)</label><input type="number" id="bal-amount"
    ...
    <div class="modal-ov" id="create-admin-modal">
        <div class="modal-box">
            ...
            <div class="modal-fld"><label>الاسم</label><input type="text" id="new-admin-name"
            ...
            <div class="modal-fld"><label>رقم الجوال</label><input type="tel" id="new-admin-phone"
    ...
    <div class="modal-ov" id="contract-modal">
        <div class="modal-box" style="max-width:560px;">
            ...
            <div style="display:flex;gap:.7rem;">
                <div class="modal-fld" style="flex:1;"><label>رقم العقد</label><input type="text" id="cn-number"
                        placeholder="CNT-005" /></div>
                <div class="modal-fld" style="flex:1;">
                    <label>نوع العقد</label>
                    <select id="cn-type"
                        style="width:100%;height:42px;padding:0 13px;border-radius:10px;border:1.5px solid var(--b1);background:var(--sur2);color:var(--t1);font-family:inherit;font-size:13.5px;outline:none;"></select>
                </div>
            </div>
            <div class="modal-fld"><label>الطرف الأول</label><input type="text" id="cn-party1"
                    placeholder="مثال: شركة آمر تم" /></div>
            <div class="modal-fld"><label>الطرف الثاني</label><input type="text" id="cn-party2"
                    placeholder="مثال: مكتب الهدى للخدمات" /></div>
            <div style="display:flex;gap:.7rem;">
                <div class="modal-fld" style="flex:1;"><label>اسم الشركة</label><input type="text" id="cn-company"
                        placeholder="اسم الشركة / المكتب" /></div>
                <div class="modal-fld" style="flex:1;"><label>سعر الخدمة (ر.س)</label><input type="number"
                        id="cn-price" min="0" step="0.01" placeholder="5000" /></div>
            </div>
            <div style="display:flex;gap:.7rem;">
                <div class="modal-fld" style="flex:1;"><label>رقم الجوال</label><input type="tel" id="cn-phone"
                        placeholder="05xxxxxxxx" /></div>
                <div class="modal-fld" style="flex:1;"><label>البريد الإلكتروني</label><input type="email"
                        id="cn-email" placeholder="info@example.com" /></div>
            </div>
            <div style="display:flex;gap:.7rem;">
                <div class="modal-fld" style="flex:1;"><label>تاريخ البداية</label><input type="date"
                        id="cn-start" /></div>
                <div class="modal-fld" style="flex:1;"><label>تاريخ النهاية</label><input type="date"
                        id="cn-end" /></div>
            </div>
            <div class="modal-fld">
                <label>الحالة</label>
            ...
            <div class="modal-btns">
                ...
                <button class="btn-pri" id="contract-save-btn" onclick="saveContract()"><i
                        class="ti ti-check"></i>حفظ العقد</button>
            </div>
        </div>
    </div>
    <!-- CONTRACT MODAL (create/view) -->
    ...
    <script>
        ...
        async function init() {
            ...
            if (u) {
                S('sb-un', u.name || T[lang].admin);
                S('sb-av-txt', (u.name || 'A')[0]);
            }
    ...
    `).join('');
        ...
        function renderReqPagination() {
            ...
            let html = '';
            if (cur > 1) html +=
                `<button onclick="loadAdminRequests(${cur-1})" style="height:36px;padding:0 12px;border-radius:8px;border:1.5px solid var(--b1);background:transparent;color:var(--t2);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${lang==='ar'?'السابق':'Prev'}</button>`;
            for (let i = Math.max(1, cur - 2); i <= Math.min(last, cur + 2); i++) {
                const on = i === cur;
                html +=
                    `<button onclick="loadAdminRequests(${i})" style="width:36px;height:36px;border-radius:8px;border:1.5px solid ${on?'var(--pri)':'var(--b1)'};background:${on?'var(--pri)':'transparent'};color:${on?'#fff':'var(--t2)'};font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${i}</button>`;
            }
            if (cur < last) html +=
                `<button onclick="loadAdminRequests(${cur+1})" style="height:36px;padding:0 12px;border-radius:8px;border:1.5px solid var(--b1);background:transparent;color:var(--t2);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${lang==='ar'?'التالي':'Next'}</button>`;
            pag.innerHTML = html;
        ...
        function renderReqList() {
            ...
            if (!el) return;
            if (!filtered.length) {
                el.innerHTML = `<div style="text-align:center;padding:3rem;color:var(--t3);">${t.noReqs}</div>`;
                return;
            }
      ...
      <div class="req-body">
        ...
        function renderPricing() {
            ...
            allServices.forEach(cat => (cat.entities || []).forEach(ent => (ent.services || []).forEach(s => svcs.push({
                ...
                color: ent.color || '#1A237E',
                bg: ent.bg || 'rgba(26,35,126,.09)'
            }))));
            if (!svcs.length) {
      ...
      <div class="fin-date">${fmtDate(p.created_at)}</div>
        ...
        async function loadAdminNotifications() {
            ...
            try {
                ...
                if (!items.length) {
                    list.innerHTML =
                        `<div class="notif-empty-p">${lang==='ar'?'لا توجد إشعارات':'No notifications'}</div>`;
                    return;
                }
                const typeColors = {
      ...
      <div class="notif-item${n.is_read ? '' : ' unread'}" onclick="adminReadNotif(${n.id}, this)">
        ...
        async function adminMarkAllRead() {
            if (typeof Notifications !== 'undefined') {
                ...
                document.querySelectorAll('#admin-notif-list .notif-item.unread').forEach(el => el.classList.remove(
                    'unread'));
                adminRefreshNotifCount();
            }
        }
  ...
  `).join('');
        ...
        function renderOffList() {
            ...
            const typeColors = {
                law: 'rgba(26,35,126,.1)',
                services: 'rgba(2,119,189,.1)',
                customs: 'rgba(0,105,92,.1)',
                accounting: 'rgba(26,35,126,.1)',
                engineering: 'rgba(26,35,126,.1)',
                freelance: 'rgba(26,35,126,.1)'
            };
            const typeClr = {
                law: '#1A237E',
                services: '#0277BD',
    ...
    `;
      ...
      ${permsHtml}
        ...
        let _contractsData = [{
                ...
                party1: 'شركة آمر تم',
                party2: 'مكتب الهدى للخدمات',
                company: 'مكتب الهدى للخدمات',
                phone: '0550000001',
            ...
            },
            {
                ...
                party1: 'شركة آمر تم',
                party2: 'مكتب المستقبل للخدمات العامة',
                company: 'مكتب المستقبل للخدمات العامة',
                phone: '0550000002',
            ...
            },
            {
                ...
                party1: 'شركة آمر تم',
                party2: 'مكتب الأمانة للاستقدام',
                company: 'مكتب الأمانة للاستقدام',
                phone: '0550000003',
                email: 'amana@example.com',
                price: 1200,
                start: '2026-02-16',
                end: '2026-08-16',
                status: 'expired'
            },
            {
                ...
                type: 'عقد الوساطة',
                party1: 'شركة آمر تم',
                party2: 'مكتب النخبة للوساطة',
                company: 'مكتب النخبة للوساطة',
                phone: '0550000004',
        ...
        let _contractTypes = [{
                name: 'عقد خدمات فورية',
                price: 3000
            },
            {
                name: 'عقد خدمات آمر تم السنوية',
                price: 15000
            },
            {
                name: 'عقد الاشتراكات في المنصة',
                price: 1200
            },
            {
                name: 'عقد الوساطة',
      ...
      <div class="c-cell c-actions cat-actions">
        ...
        function editContract(id) {
            ...
            renderContractTypeOptions(c.type);
            document.getElementById('cn-number').value = c.number;
            document.getElementById('cn-party1').value = c.party1 || '';
            document.getElementById('cn-party2').value = c.party2 || '';
            document.getElementById('cn-company').value = c.company || '';
            document.getElementById('cn-phone').value = c.phone || '';
            document.getElementById('cn-email').value = c.email || '';
            document.getElementById('cn-price').value = c.price != null ? c.price : '';
        ...
        function addContract() {
            ...
            S('contract-modal-ttl', 'إضافة عقد جديد');
            renderContractTypeOptions();
            const numEl = document.getElementById('cn-number');
            numEl.value = 'CNT-' + String(_contractIdSeq).padStart(3, '0');
            ['cn-party1', 'cn-party2', 'cn-company', 'cn-phone', 'cn-email', 'cn-price', 'cn-start', 'cn-end'].forEach(id => {
        ...
        function renderContractTypeOptions(selected) {
            const sel = document.getElementById('cn-type');
            if (!sel) return;
            sel.innerHTML = _contractTypes.map(t =>
        ...
        function saveContract() {
            ...
            const party1 = document.getElementById('cn-party1')?.value?.trim();
            const party2 = document.getElementById('cn-party2')?.value?.trim();
            const company = document.getElementById('cn-company')?.value?.trim();
            const phone = document.getElementById('cn-phone')?.value?.trim();
            const email = document.getElementById('cn-email')?.value?.trim();
            const price = parseFloat(document.getElementById('cn-price')?.value);
      ...
      <div class="req-hd" onclick="openContractType('${escJs(t.name)}')" style="cursor:pointer;">
        ...
        <button class="cat-act-btn edit" onclick="event.stopPropagation();showContractTypeForm('${escJs(t.name)}')" title="تعديل اسم النوع وسعره">تعديل</button>
        <button class="cat-act-btn del" onclick="event.stopPropagation();deleteContractType('${escJs(t.name)}')" title="حذف النوع"><i class="ti ti-trash"></i></button>
        ...
        function saveContractType() {
            ...
            if (_editingContractTypeName) {
                ...
                const existing = _contractTypes.find(x => x.name === oldName);
                if (!existing) return;
                if (oldName !== name) {
                    if (_contractTypes.some(x => x.name === name)) {
                        showToast('يوجد نوع عقد بنفس الاسم مسبقاً', 'warning');
                        return;
                    }
                    if (_clausesByType[oldName]) {
                        _clausesByType[name] = _clausesByType[oldName];
                        delete _clausesByType[oldName];
                    }
                    if (_activeContractType === oldName) _activeContractType = name;
                    _contractsData.forEach(c => {
                        if (c.type === oldName) c.type = name;
                    });
                }
                existing.name = name;
                ...
                if (!_clausesByType[name]) _clausesByType[name] = [];
        ...
        function deleteContractType(name) {
            if (!confirm(`هل أنت متأكد من حذف نوع العقد «${name}»؟`)) return;
            _contractTypes = _contractTypes.filter(x => x.name !== name);
            delete _clausesByType[name];
            if (_activeContractType === name) _activeContractType = null;
            renderContractTypeList();
            renderContractsList();
    ...
    <div class="cat-row clause-row">
      ...
      <div class="usr-actions">
        ...
        function renderUserPagination() {
            ...
            let html = '';
            if (cur > 1) html +=
                `<button onclick="_usrPage=${cur-1};loadUsers()" style="height:36px;padding:0 12px;border-radius:8px;border:1.5px solid var(--b1);background:transparent;color:var(--t2);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">السابق</button>`;
            for (let i = Math.max(1, cur - 2); i <= Math.min(last, cur + 2); i++) {
                const on = i === cur;
                html +=
                    `<button onclick="_usrPage=${i};loadUsers()" style="width:36px;height:36px;border-radius:8px;border:1.5px solid ${on?'var(--pri)':'var(--b1)'};background:${on?'var(--pri)':'transparent'};color:${on?'#fff':'var(--t2)'};font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${i}</button>`;
            }
            if (cur < last) html +=
                `<button onclick="_usrPage=${cur+1};loadUsers()" style="height:36px;padding:0 12px;border-radius:8px;border:1.5px solid var(--b1);background:transparent;color:var(--t2);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">التالي</button>`;
            pag.innerHTML = html;
    ...
    <div class="an-svc-row">
      ...
      <div style="text-align:left;min-width:80px;">
        ...
        function renderLogList(logs, meta) {
            ...
            if (!el) return;
            if (!logs.length) {
                el.innerHTML = '<div style="text-align:center;padding:3rem;color:var(--t3);">لا توجد سجلات</div>';
                return;
            }
      ...
      <div class="log-date">${fmtDate(l.created_at)}</div>
        ...
        function renderLogPagination(meta) {
            ...
            let html = '';
            if (cur > 1) html +=
                `<button onclick="_logPage=${cur-1};loadLogs()" style="height:36px;padding:0 12px;border-radius:8px;border:1.5px solid var(--b1);background:transparent;color:var(--t2);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">السابق</button>`;
            for (let i = Math.max(1, cur - 2); i <= Math.min(last, cur + 2); i++) {
                const on = i === cur;
                html +=
                    `<button onclick="_logPage=${i};loadLogs()" style="width:36px;height:36px;border-radius:8px;border:1.5px solid ${on?'var(--pri)':'var(--b1)'};background:${on?'var(--pri)':'transparent'};color:${on?'#fff':'var(--t2)'};font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">${i}</button>`;
            }
            if (cur < last) html +=
                `<button onclick="_logPage=${cur+1};loadLogs()" style="height:36px;padding:0 12px;border-radius:8px;border:1.5px solid var(--b1);background:transparent;color:var(--t2);font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;">التالي</button>`;
            pag.innerHTML = html;
        ...
        function exportOfficeFinancialCSV() {
            if (!_oflData) {
                alert('يرجى تحميل البيانات أولاً');
                return;
            }
